...
echo Compiling RepoSessionFix.dll...

:: /noconfig and /nostdlib+ ensure total isolation from Windows DLLs
%CSC% /noconfig /nostdlib+ /target:library /out:RepoSessionFix.dll ^
...
if %errorlevel% equ 0 (
    ...
    copy /y RepoSessionFix.dll "C:\Users\gil\AppData\Roaming\com.kesomannen.gale\repo\profiles\Default\BepInEx\plugins\"
) else (
    echo.
